...
namespace odev
{
    public partial class SozlesmeliForm : Form
    {
        ...
        public SozlesmeliForm()
        {
            InitializeComponent();
        }

        private void SozlesmeliForm_Load(object sender, EventArgs e)
        {
            string sorgu = "select * from sozlesmeli";
        ...
        {
            SozlesmeliForm prsn3 = new SozlesmeliForm();
            this.Hide();
        }
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            {
                baglan.Open();
                NpgsqlCommand komut2 = new NpgsqlCommand("Delete from sozlesmeli where personel_id=@p1", baglan);
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            {
                baglan.Open();
                string ara = "SELECT * from sozlesmeli where personel_id=@p1";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            if (!string.IsNullOrWhiteSpace(txtpersonelid.Text) & !string.IsNullOrWhiteSpace(txtpersonelad.Text) & !string.IsNullOrWhiteSpace(txtpersonelsoyad.Text) & !string.IsNullOrWhiteSpace(txtpersoneltipno.Text) & !string.IsNullOrWhiteSpace(txtpersoneltipad.Text) & !string.IsNullOrWhiteSpace(txtpersonelucret.Text) & !string.IsNullOrWhiteSpace(txtsozlesmeno.Text))
            {
                ...
                komut1.Parameters.AddWithValue("@p7", int.Parse(txtsozlesmeno.Text));
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            {
                baglan.Open();
                string kayit2 = "update sozlesmeli set personel_id=@p1,ad=@p2,soyad=@p3,personel_tip_no=@p4,personel_tip_ad=@p5,ucret=@p6,sozlesme_no=@p7 where personel_id=@p1";
                ...
                komut5.Parameters.AddWithValue("@p7", int.Parse(txtsozlesmeno.Text));
